  ...
  <div class="min-h-screen bg-gray-50 flex">
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 class="text-3xl font-bold text-gray-800">{{ $t('category_management') }}</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-500 text-sm font-medium">{{ $t('total_category') }}</p>
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-4 border-b border-gray-100">
          ...
          <div class="flex items-center gap-2">
            <label class="text-sm text-gray-600">{{ $t('show') }}</label>
            <select v-model="categoriesPerPage"
              ...
              <tr v-for="category in filteredCategories" :key="category.id" class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex-shrink-0 h-10 w-10">
                    <img v-if="category.image" :src="category.image" alt="Category"
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <div class="flex justify-end gap-2">
                    <button @click="showViewModal(category)"
                    ...
                    <button @click="showEditModal(category)"
        ...
        <div class="p-6">
              ...
              <div>
                ...
                <div class="mt-1 flex items-center">
                  <label for="image-upload" class="cursor-pointer">
                    <div
                      class="flex flex-col items-center justify-center px-6 py-8 border-2 border-dashed border-gray-300 rounded-lg hover:border-gray-400 transition">
            ...
            <div class="space-y-6">
              <div class="flex flex-col items-center">
                <div class="mb-4 h-32 w-32 rounded-full bg-gray-100 overflow-hidden border-4 border-white shadow-md">
                  <img v-if="currentCategory.image" :src="currentCategory.image" alt="Category"
              ...
              <div>
                ...
                <div class="flex items-center gap-4">
                  ...
                  <label for="edit-image-upload" class="cursor-pointer">
                    ...
                    <input id="edit-image-upload" type="file" @change="handleImageEditUpload" class="sr-only"
                      accept="image/*">
                  </label>
                </div>
          ...
          <template v-else-if="modalType === 'delete'">
            <div class="text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-16 w-16 text-red-500" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <p class="mt-2 text-sm text-gray-500">
                Are you sure you want to delete <span class="font-semibold">"{{ currentCategory.name }}"</span>? This
              ...
              <div class="mt-6 flex justify-center space-x-4">
                ...
                <button @click="handleDeleteCategory(currentCategory.id)" type="button"
