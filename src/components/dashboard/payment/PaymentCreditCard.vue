                        ...
                        <form @submit.prevent="handleSubmit" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input v-model="cardholderName"
                                    ...
                                    type="text" required :disabled="loading" placeholder="John Doe">
                            </div>
                            ...
                            <!-- Form Error -->
                            <div v-if="formError"
                                class="mt-2 p-3 rounded-lg bg-red-50 border border-red-200 flex items-start gap-3">
...
export default {
    ...
    data() {
        return {
            ...
            loading: false,
            formError: null,
            ispaidAlready: localStorage.getItem('order_paid') === 'true',
        };
    },
    computed: {
        isPaidAlready() {
