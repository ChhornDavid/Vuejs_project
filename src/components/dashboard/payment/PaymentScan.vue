                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div v-if="resultMessage"
                            ...
                            <svg v-if="resultMessage.includes('success')" xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 text-green-600 mt-0.5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
                            <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-600 mt-0.5"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                            <p
                                :class="['text-sm', resultMessage.includes('success') ? 'text-green-700' : 'text-red-700']">
                                {{ resultMessage }}
                            </p>
                        </div>
